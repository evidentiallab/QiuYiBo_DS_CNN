...
model_e.load_weights('/home/utseus/QYB_test/E-CNN-classifier-main/weight_qyb/cnn_model.h5',by_name = True) #please give our own filepath to save the weights of the probabilistic FitNet-4 classifier
